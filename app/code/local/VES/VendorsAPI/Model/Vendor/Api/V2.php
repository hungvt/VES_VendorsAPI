<?php
class VES_VendorsAPI_Model_Vendor_Api_V2 extends VES_VendorsAPI_Model_Api_Resource
{
    ...
    public function updateProduct($vendorApiKey, $productId, $productData, $identifierType = null)
    {
        ...
        try {
            ...
            $this->_fault('data_invalid', $e->getMessage());return false;
        }
    ...
    public function deleteProduct($vendorApiKey, $productId, $identifierType = null)
    {
        ...
        try {
            $product->delete();return true;
        } catch (Mage_Core_Exception $e) {
            $this->_fault('product_not_deleted', $e->getMessage());return false;
        }
